...
**Assignment**: `vector`  
**Scheduled**: 09-13-21 00:23:00  
**Revision**: a2d50ae59d6c4d0be6da77e9b83eecb07bdd5d9b  
...
==195== Command: ./vector_test 18 101
==195== Parent PID: 7
==195== 
==195== 
==195== HEAP SUMMARY:
==195==     in use at exit: 133 bytes in 7 blocks
==195==   total heap usage: 23 allocs, 16 frees, 586 bytes allocated
==195== 
==195== 133 bytes in 7 blocks are definitely lost in loss record 1 of 1
==195==    at 0x4C31B0F: malloc (in /usr/lib/valgrind/vgpreload_memcheck-amd64-linux.so)
==195==    by 0x547DAF9: strdup (strdup.c:42)
==195==    by 0x400CB8: vector_set (in /tmp/tmproybun5f/vector_test)
==195==    by 0x40201D: check_memory (in /tmp/tmproybun5f/vector_test)
==195==    by 0x40466B: main (in /tmp/tmproybun5f/vector_test)
==195== 
==195== LEAK SUMMARY:
==195==    definitely lost: 133 bytes in 7 blocks
...
5971affba00c643b26c5b30e5498e5a95d3bd57b sstring.c
