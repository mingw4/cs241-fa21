...
**Assignment**: `vector`  
**Scheduled**: 09-12-21 17:31:00  
**Revision**: 58b7c67cbfcf6dcad7b97ca045f1479d3446ac1c  
**Score**: **33.0** out of **40.0** points
...
==195== Command: ./vector_test 18 90
==195== Parent PID: 7
==195== 
==195== 
==195== Process terminating with default action of signal 6 (SIGABRT): dumping core
==195==    at 0x541EFB7: raise (raise.c:51)
==195==    by 0x5420920: abort (abort.c:79)
==195==    by 0x5410489: __assert_fail_base (assert.c:92)
==195==    by 0x5410501: __assert_fail (assert.c:101)
==195==    by 0x4010CD: vector_erase (in /tmp/tmpsd7igi2r/vector_test)
==195==    by 0x4020CE: check_memory (in /tmp/tmpsd7igi2r/vector_test)
==195==    by 0x40466B: main (in /tmp/tmpsd7igi2r/vector_test)
==195== 
==195== HEAP SUMMARY:
==195==     in use at exit: 456 bytes in 10 blocks
==195==   total heap usage: 26 allocs, 16 frees, 1,100 bytes allocated
==195== 
==195== LEAK SUMMARY:
==195==    definitely lost: 0 bytes in 0 blocks
==195==    indirectly lost: 0 bytes in 0 blocks
==195==      possibly lost: 0 bytes in 0 blocks
==195==    still reachable: 456 bytes in 10 blocks
...
5c4ffb02319f566aa8230d16cb1ce5b500b2f3f2 vector.c  
b966f5d89a901e97303b6b47361143c312e082f9 sstring.c
